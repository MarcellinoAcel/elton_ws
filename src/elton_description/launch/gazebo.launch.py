...
def generate_launch_description():
    ...
    ekf_config_path = PathJoinSubstitution(
        [FindPackageShare("elton_description"), "config", "ekf.yaml"]
    )

    world_path = PathJoinSubstitution(
        [FindPackageShare("elton_description"), "worlds", "empty.world"]
    )

    description_launch_path = PathJoinSubstitution(
        [FindPackageShare('elton_description'), 'launch', 'description.launch.py']
    )
    twist_mux_params = PathJoinSubstitution(
        [FindPackageShare("elton_description"), 'config', 'twist_mux.yaml']
    )
    ...
    rviz_config_path = PathJoinSubstitution(
        [FindPackageShare('elton_description'), 'rviz', 'elton_description.rviz']
    )
    rviz_node = Node(
